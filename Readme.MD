...
| Feature | Description |
|---|---|
| **AOB Scanning** | 96 entries (91 patterns + 5 exports) from 7 sources. Supports `FChunkedFixed` and `FFixed` object arrays. Encrypted GObjects + preset layout detection. |
