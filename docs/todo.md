...
> maintainer-only file deletion. The other four rows are **new** — three surfaced by the audit
> programme itself on 2026-08-19, one (`[PROXYDEPS]`) by the overnight verification run — and were
> deliberately deferred — none is a regression, and each states its own
> reason for waiting. So "12 → 1" is the honest headline for the original queue, and **5** is the
> honest row count of this table — the fifth, `[PROXYDEPS]`, was added 2026-08-19 by the overnight
> verification run, again in passing rather than by a scan.
...
### 🟡 5-of-6 CLOSED (steps 2+3 on 2026-08-19) — AE4–AE7: the Proxy Deploy panel, two buttons at once
