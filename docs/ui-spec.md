...
- **Testing**: `xunit.v3 4.x` (4.0.1 on 2026-09-25), `Microsoft.Testing.Platform` v2 (xunit.v3 4 dropped MTP v1), **~3200 tests across ~135 files** (2026-08-05; an absolute count here rots within days — run the suite)
