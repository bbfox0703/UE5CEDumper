# Dev Log — archived (builds 2779–3261)

Split out of [`../dev-log.md`](../dev-log.md) on 2026-09-26, when the live file reached
**456 KB** — past the 400 KB the earlier splits used as their trigger. Cut on the **date** boundary
2026-08-18: the 75 entries dated 2026-08-10 … 2026-08-17 moved, and the live log keeps
2026-08-19+ (builds 3263+). **Nothing was edited, only moved**, so every entry reads exactly as it
did in the live log; `dev-log.md:NNNN` line citations elsewhere are stale from this date — grep the
build number or the finding id instead.

Older halves, newest range first:
[`dev-log-2026-08-pre-build-2779.md`](dev-log-2026-08-pre-build-2779.md) (2220–2747) ·
[`dev-log-2026-07-pre-build-2200.md`](dev-log-2026-07-pre-build-2200.md) (1800–2168) ·
[`dev-log-2026-06-pre-build-1800.md`](dev-log-2026-06-pre-build-1800.md) (1178–1799) ·
[`dev-log-2026-06-pre-build-1180.md`](dev-log-2026-06-pre-build-1180.md) ·
[`dev-log-2026-06-pre-build-940.md`](dev-log-2026-06-pre-build-940.md) ·
