...
| **AA10** | LOW | `ue5_freeze_helper.lua:341` (fetchInstancePage) | The mailbox has two mutually-blind concurrency guards: generated scripts wait for cmd==IDLE, the standalone helpers use a Lua flag no generated script sets | M / low |
...
**Current register: 171 open of 291 · 0 HIGH · 6 MED · 138 LOW · 27 INFO.** Re-derive with
