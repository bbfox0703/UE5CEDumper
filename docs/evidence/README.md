...
| [`2026-09/crc-version-source/`](2026-09/crc-version-source/) | `[CRCSOURCE-2026-09-06]` | [`../dev-log.md`](../dev-log.md) | 3393 | `CrashReportClient.exe` is read as a second version source — both the AGREE and the DISAGREE branch, on a manufactured case the rig can only replay while the UE Editors remain installed |
