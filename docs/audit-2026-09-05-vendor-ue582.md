...
| `docs/reversing-nonstandard-ue-games.md:41` | Half a sentence noting UEPseudo is browsed on GitHub, not checked out, so the next reader does not mistake the empty `vendor/RE-UE4SS/deps/first/Unreal/` for breakage. |
