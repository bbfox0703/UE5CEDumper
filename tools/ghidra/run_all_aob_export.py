...
# USB drive. `GHIDRA_PROJS` is the same env var sweep.sh:19, preflight.py `main` and
# build_corpus_manifest.py `main` already honour; the literal is only a fallback for whichever
