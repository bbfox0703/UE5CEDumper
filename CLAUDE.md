...
|      |  loadLibrary / callFunction (60 C ABI exports)
|      v
...
| [docs/dll-spec.md](docs/dll-spec.md) | C++ DLL interface — C ABI exports (**60** — derive it, never hand-edit), the public headers, DynOff runtime offset tables, the CE Lua inject-only bridge. ⚠ The headers are ground truth; this doc trails them. |
