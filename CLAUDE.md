...
| [docs/architecture.md](docs/architecture.md) | Directory structure (**31 .cpp + 40 .h** DLL files, **200** test files, and what each does), git submodules, build environment, component interaction + startup sequence, log layout + retention. |
